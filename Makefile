...
SRCFILE = main Config Server Location parsing parsingUtils running Client parsingLocation Request/processRequest Request/Request Request/utils handleClients Request/parseRequest
SRCDIR= src/
SRCFORMAT=.cpp
